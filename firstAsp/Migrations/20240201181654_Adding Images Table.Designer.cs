...
namespace firstAsp.Migrations
{
    ...
    [Migration("20240201181654_Adding Images Table")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("firstAsp.Models.Domain.Difficulty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ea8282fa-30f9-4bb7-bbd8-43d02c3d89d5"),
                            Name = "Easy"
                        },
                        new
                        {
                            Id = new Guid("c513e214-9a0c-4dae-a908-151832510734"),
                            Name = "Medium"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("firstAsp.Models.Domain.Walk", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("firstAsp.Models.Domain.Walk", b =>
                {
                    b.HasOne("firstAsp.Models.Domain.Difficulty", "Difficulty")
                        .WithMany()
                        .HasForeignKey("DifficultyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("firstAsp.Models.Domain.Region", "Region")
                        .WithMany()
